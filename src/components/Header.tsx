    ...
    <>
      <header id="header" className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-sm z-50 shadow-sm">
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between h-auto sm:h-20 py-4 sm:py-0 cursor-pointer">
            {/* Logo and icons */}
            <div onClick={handleTitleClick} className="flex flex-col sm:flex-row items-center space-x-2 sm:space-x-2 mb-4 sm:mb-0">
